...
export const translations = {
  ...
  "zh-Hant": {
    ...
    "about.title": "關於我",
    "about.description":
      "我是梁嘉晉，香港科技大學計算機科學和工商管理雙學位學生。我對人工智能、機器人和科技創新充滿熱情。憑藉在華為的研究經驗、科大機器人團隊的領導經驗以及實際的人工智能項目，我致力於將技術與創業相結合。通過在清華大學和代爾夫特理工大學的國際交流經驗，我期望創造連接人工智能、商業和現實世界挑戰的解決方案。",
  ...
  "zh-Hans": {
    ...
    "about.title": "关于我",
    "about.description":
      "我是梁嘉晋，香港科技大学计算机科学和工商管理双学位学生。我对人工智能、机器人和科技创新充满热情。凭借在华为的研究经验、科大机器人团队的领导经验以及实际的人工智能项目，我致力于将技术与创业相结合。通过在清华大学和代尔夫特理工大学的国际交流经验，我期望创造连接人工智能、商业和现实世界挑战的解决方案。",
